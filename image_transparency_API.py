...
async def make_transparent(image: UploadFile = File(...)):
    # 讀取圖片文件
    ...
    # return Response(content=original_image, media_type='image/png')
    # return Response(content=original_image, transparent_image, media_type='image/png')

    # return [Response(content=original_image, media_type='image/png'), Response(content=transparent_image, media_type='image/png')]
